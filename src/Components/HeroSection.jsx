...
function HeroSection() {
  ...
  return (
    <>
      <div className="bg-gray-950 text-amber-50 flex-grow">
      ...
      <footer>
        <div className="bg-black text-amber-50 p-4 flex items-center justify-center text-sm sm:text-lg bottom-0">
